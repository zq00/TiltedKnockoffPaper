...
- src: source functions used in simulations throughout
- intro: simulations in section 2.1 and section 2.2 (exact tilted knockoffs) and supplement section 1.
...
- Real: analysis of secondary phenotype using a case-control sample (section 4 and supplement section 4)
- Supplement: generating tilted knockoff using metro and deep knockoff (supplement section 3)
